...
const LandingNavbar:React.FC<NavbarProps> = () => {
    ...
    return <div className='flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12 py-6'>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div className='cursor-pointer border border-brand-orange bg-brand-orange/10 hover:bg-white px-4 py-2 sm:px-6 sm:py-2.5 rounded-lg text-base sm:text-lg font-semibold
            bg-brand-orange text-white transition duration-300 ease-in-out'>Sign In</div>
            </Link>
